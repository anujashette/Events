    ...
    <div className="footer">
        <div className="privacy-note">
            ...
            <p className="description">
                By using www.bookeventz.com(our website), you are fully accepting the Privacy Policy available at
            <span class="ca fp">&nbsp; https://bookeventz.com/privacy &nbsp;</span>
            governing your access to Bookeventz and provision of services by Bookeventz to you. If you do not accept terms mentioned in the
            <span class="ca fp">&nbsp; Privacy Policy</span>,&nbsp;
            you must not share any of your personal information and immediately exit Bookeventz
            </p>
        </div>
        ...
        <div className="book-ticket-city">
            <div className="inner-div">
                <div className="list-div">
                    <a href="#">
                        Online Movie Ticket Booking Mumbai
                    </a>
                    <div>|</div>
                    <a href="#">Online Movie Ticket Booking Delhi</a>
                    <div>|</div>
                    <a href="#">
                        Online Movie Ticket Booking Bengaluru</a>
                    <div>|</div>
                    <a href="#">
                        Online Movie Ticket Booking Hyderabad</a>
                    <div>|</div>
                    <a href="#">
                        Online Movie Ticket Booking Chennai</a>
                    <div>|</div>
                    <a href="#">
                        Online Movie Ticket Booking Kolkata</a>
                    <div>|</div>
                    <a href="#">
                        Online Movie Ticket Booking Noida</a>
                    <div>|</div>
                    <a href="#">
                        Online Movie Ticket Booking Ahmedabad</a>
                    <div>|</div>
        ...
        <div className="footer-element">
            <div className="entity">
                <div className="title"> THINGS TO DO IN MUMBAI</div>
                <div className="list-div">
                    <a href="#"> Adventure Activities in Mumbai</a>
                    <div>|</div>
                    <a href="#"> Family Tours in Mumbai</a>
                    <div>|</div>
                    <a href="#"> Amusement Parks in Mumbai</a>
                    <div>|</div>
                    <a href="#"> Gaming Events in Mumbai</a>
                    <div>|</div>
                    <a href="#">
                        Nightlife Events in Mumbai</a>
                    <div>|</div>
                    <a href="#">
                        Places To Visit in Mumbai</a>
                    <div>|</div>
                    <a href="#">
                        Tourist Attractions in Mumbai</a>
                    <div>|</div>
                    <a href="#">
                        Food Events in Mumbai</a>
                </div>
            </div>
            <div className="entity">
                <div className="title">MOVIES BY GENRE</div>
                <div className="list-div">
                    <a href="#"> Best Action Movies</a>
                    <div>|</div>
                    <a href="#"> Best Romantic Movies</a>
                    <div>|</div>
                    <a href="#"> Best Comedy Movies</a>
                    <div>|</div>
                    <a href="#"> Best Adult Movies</a>
                    <div>|</div>
                    <a href="#"> Best Adventure Movies</a>
                    <div>|</div>
                    <a href="#"> Best Biography Movies</a>
                    <div>|</div>
                    <a href="#"> Best Classic Movies</a>
                    <div>|</div>
                    <a href="#"> Best Crime Movies</a>
                    <div>|</div>
                    <a href="#"> Best Drama Movies</a>
                    <div>|</div>
                    ...
                    <div>|</div>
                    <a href="#"> Best Musical Movies</a>
                    <div>|</div>
                    <a href="#"> Best Mystery Movies</a>
                    <div>|</div>
                    <a href="#"> Best Suspense Movies</a>
                    <div>|</div>
                    <a href="#"> Best Sci-Fi Movies</a>
                    <div>|</div>
                    <a href="#"> Best Thriller Movies</a>
                    <div>|</div>
                    <a href="#"> Best Western Movies</a>
                </div>
            </div>
            <div className="entity">
                <div className="title">POPULAR MOVIES BY LANGUAGE</div>
                <div className="list-div">
                    <a href="#">
                        Popular Hindi Movies                </a>
                    <div>|</div>
                    <a href="#">Popular English Movies</a>
                    <div>|</div>
                    <a href="#">
                        Popular Marathi Movies</a>
                    <div>|</div>
                    <a href="#">
                        Popular Bengali Movies</a>
                    <div>|</div>
                    <a href="#">
                        Popular Tamil Movies</a>
                    <div>|</div>
                    <a href="#">
                        Popular Telugu Movies</a>
                    <div>|</div>
                    <a href="#">
                        Popular Malayalam Movies</a>
                    <div>|</div>
                    <a href="#">
                        Popular Bhojpuri Movies</a>
                    <div>|</div>
                    <a href="#">Popular Punjabi Movies</a>
                    <div>|</div>
                    <a href="#">
                        Popular Bhojpuri Movies</a>
                    <div>|</div>
                    <a href="#">
                        Popular Gujarati Movies</a>
                    <div>|</div>
                    <a href="#">
                        Popular Sindhi Movies</a>
                </div>
            </div>
            <div className="entity">
                <div className="title">MOVIES REVIEWS</div>
                <div className="list-div">
                    <a href="#">
                        Trending Articles
                    </a>
                    ...
                    <div>|</div>
                    <a href="#">
                        Latest News on Movies, Events, Plays &amp; Sports
                    </a>
                    <div>|</div>
                    <a href="#">
                        Rajeev Masand Movie Reviews</a>
                    <div>|</div>
                    <a href="#">
                        Anupama Chopra Movie Review</a>
                    <div>|</div>
                    <a href="#">
                        Film Reviews</a>
                    <div>|</div>
            ...
            <div className="entity">
                ...
                <div className="entity entity-2">
                    <div className="title">EVENTS CALENDER</div>
                    <div className="list-div">
                        <a href="#">
                            Events Near Me Today</a>
                        <div>|</div>
                        <a href="#">Events Happning Tomorrow</a>
                        <div>|</div>
                        <a href="#">
            ...
            <div className="entity">
                <div className="title">EVENTS TICKET BOOKING ONLINE</div>
                <div className="list-div">
                    <a href="#">
                        Upcoming Events in Mumbai                </a>
                    <div>|</div>
                    <a href="#">Upcoming Events in Delhi</a>
                    <div>|</div>
                    <a href="#">
                        Upcoming Events in Bengaluru</a>
                    <div>|</div>
                    <a href="#">
                        Upcoming Events in Chennai</a>
                    <div>|</div>
                    <a href="#">
                        Upcoming Events in Hyderabad</a>
                    <div>|</div>
                    <a href="#">
                        Upcoming Events in Pune</a>
                    <div>|</div>
                    <a href="#">
                        Upcoming Events in Noida</a>
                    <div>|</div>
                    <a href="#">
                        Upcoming Events in Ahmedabad</a>
                </div>
            </div>
            <div className="entity">
                <div className="title">EVENTS TICKET BOOKING ONLINE</div>
            ...
            <div className="entity">
                <div className="entity entity-1">
                    <div className="title">EVENTS BY MOOD</div>
                    <div className="list-div">
                        <a href="#">
                        </a>
                        <a href="#">
            ...
            <div className="entity">
                <div className="title">BOOKMYSHOW APP</div>
                <div className="list-div">
                    <a href="#">
                        BMS Ticketing iOS App                </a>
                    <div>|</div>
                    <a href="#">BMS Ticketing Android App</a>
                </div>
            </div>
            <div className="entity">
                <div className="title">BOOKMYSHOW NEWS</div>
                <div className="list-div">
                    <a href="#">
                        Buzz                </a>
                    <div>|</div>
            ...
            <div className="entity">
                <div className="title">EXCLUSIVES</div>
                <div className="list-div">
                    <a href="#">
                        BookASmile </a>
                    <div>|</div>
        ...
        <div className="footer-bottom">
            <div className="inner-div">
                <div className="logo">
                    ...
                    <div className="company-name">BookEventz</div>
                    <div className="line"></div>
                </div>
                <div className="share-icon">
                    <a href="https://www.facebook.com/BookEventz">
                        <svg className="icon" xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 98 98">
                    ...
                    <a href="https://twitter.com/BookEventz/" >
                        <svg className="icon" xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 98 98">
                    ...
                    <a href="https://www.instagram.com/BookEventz/">
                        <svg className="icon" xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 102 102">
                    ...
                    <a href="https://www.youtube.com/user/BookEventz/featured">
                        <svg className="icon" xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 102 102">
                    ...
                    <a href="https://www.pinterest.com/BookEventz/">
                        <svg className="icon" xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 102 102">
                    ...
                    <a href="https://www.linkedin.com/company/BookEventz/">
                        <svg className="icon" xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 102 102">
                ...
                "Copyright" "2020" © "Book Eventz Pvt. Ltd. All Rights Reserved."
